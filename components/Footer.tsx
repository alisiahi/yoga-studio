...
const Footer = () => {
  return (
    <footer className="border-t bg-primary-300 pt-24" id="contact">
        ...
        >
          ...
          <motion.div variants={footerItem}>
            ...
            <div className="border-b border-dotted border-gray-400 flex flex-col gap-3 pb-3 mb-4">
              <Link href="#" className="hover:text-accent transition-all">
                <h5 className="h5 leading-snug">Yoga: Unleash you potential</h5>
            ...
            <div className="border-b border-dotted border-gray-400 flex flex-col gap-3 pb-3 mb-4">
              <Link href="#" className="hover:text-accent transition-all">
                <h5 className="h5 leading-snug">The joy of yoga</h5>
                <p className="text-gray-400 text-[12px] tracking-[3px] uppercase">
                  March 24, 2024
                </p>
              </Link>
            ...
            <div className="flex flex-col gap-3 pb-3 mb-4">
              <Link href="#" className="hover:text-accent transition-all">
                <h5 className="h5 leading-snug">Finding balance with yoga</h5>
                <p className="text-gray-400 text-[12px] tracking-[3px] uppercase">
                  March 23, 2024
                </p>
              </Link>
          ...
          <motion.div variants={footerItem}>
            ...
            <div className="flex flex-wrap gap-2">
              <Link href="#">
                <Image
                  src="/assets/img/trainers/tom.jpg"
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src="/assets/img/trainers/lara.jpg"
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src="/assets/img/trainers/leonardo.jpg"
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src="/assets/img/trainers/sara.jpg"
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src="/assets/img/trainers/denzel.jpg"
                  width={100}
                  height={100}
                  alt=""
                />
      ...
      <div className="text-white border-t border-white/20 py-12">
        <div className="container mx-auto h-full">
          <div className="flex items-center justify-between h-full">
            <span>&copy; Copyright 2024 Yoga Studio</span>
