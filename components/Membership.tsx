...
const Membership = () => {
  return (
    <motion.section
      ...
      className="py-8 xl:py-0 lg:min-h-[95vh] bg-membership bg-cover bg-center relative before:w-full before:h-full before:bg-black/50 before:absolute before:top-0 before:z-10"
      id="prices"
    >
