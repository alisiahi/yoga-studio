...
const testimonialData = [
  {
    ...
    message:
      "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorum sed, nam dicta modi natus culpa.",
    name: "Lucy Anthony",
  },
  {
...
const Testimonial = () => {
  return (
    <section className="py-12 xl:py-28 lg:pt-36" id="testimonial">
